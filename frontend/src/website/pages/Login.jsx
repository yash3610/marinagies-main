...
export default function Login() {
  return (
    <PageLayout pageSlug="login" title="MarineAegis - Autonomous Maritime Cyber Defense" variant="inner">
<>{/* Breadcrumb Start */}
  <div className="breadcrumb-area bg-f round-20 position-relative z-1">
    <div className="container text-center">
      <ul className="br-menu text-center bg_secondary d-inline-block list-unstyled mb-15">
        ...
        <li className="position-relative fs-13 fw-semibold ls-1 d-inline-block">LOGIN</li>
      </ul>
      <h2 className="section-title style-one fw-medium font-secondary text-black text-center mb-6">Login</h2>
    </div>
  </div>
  {/* Breadcrumb End */}
  {/* Account Section Start */}
  <div className="container ptb-130">
    <div className="account-wrap style-one bg-f position-relative z-1">
      <div className="row">
        <div className="col-lg-6">
          <div className="account-box round-10">
            <h4 className="fs-20 fw-semibold text-center mb-2">Sign In To Your Account</h4>
            <p className="text-center mb-22">Access the secure MarineAegis operator portal</p>
            ...
            <form action="#" className="form-wrapper style-two" autoComplete="on">
              ...
              <div className="form-group mb-20">
                <input name="password" type="password" autoComplete="current-password" maxLength="128" required placeholder="Password*" className="w-100 border-0 round-10 outline-0 text-para" />
              </div>
              <div className="form-check checkbox style-two mb-25">
                <input className="form-check-input" type="checkbox" id="login-terms" required />
                <label className="form-check-label text-para" htmlFor="login-terms">
              ...
              <button className="btn style-12 position-relative z-1 w-100 fw-medium d-block border-0" type="submit">Login</button>
              <p className="mt-4 mb-0">Don't have an account? <a href="/register" className="text_primary link-hover-primary">Register</a></p>
            </form>
          </div>
        </div>
      </div>
