...
export default function BlogLeftSidebar() {
  return (
    <PageLayout pageSlug="blog-left-sidebar" title="MarineAegis - Autonomous Maritime Cyber Defense" variant="inner">
<>{/* Breadcrumb Start */}
  ...
  <div className="container style-one ptb-130">
    <div className="row">
      <div className="col-xl-4 ps-xxl-5 order-xl-1 order-2">
